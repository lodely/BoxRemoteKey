...
import com.android.boxremotekey.Environment;
...
public class RemoteServer extends NanoHTTPD
{
    ...
    private void addGetRequestProcessers(){
        ...
        this.getRequestProcessers.add(new RawRequestProcesser(this.mContext, "/logo.png", R.drawable.ic_launcher, "image/png"));
