...
> 本项目基于 小盒精灵[cacaview/TVRemoteIME](https://github.com/cacaview/TVRemoteIME) 修改而来，在此向原作者及上游社区致谢。
...
- **新增中文输入法功能**：在原有英文软键盘基础上，增加了中文（拼音）输入引擎与候选词面板，支持在电视盒子端通过物理键盘或远程键盘进行中文输入，候选词可上屏、翻页、数字选词。
